...
<section class="py-5">
    ...
    <div class="row my-5">
        <div class="col-md-6 mt-md-0 mt-4">
            <p>Selamat! Kamu telah menjadi pngguna layanan PT Kereta Api Indonesia <br>Berikut kartu membermu :</p>
            <div class="card">
                <div class="card-header d-flex justify-content-start">
                    <img src="{{ asset('assets/images/kai.png') }}" class="img-fluid" width="30">
